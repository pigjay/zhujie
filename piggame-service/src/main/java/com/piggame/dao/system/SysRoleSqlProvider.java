...
import com.piggame.model.system.SysRoleExample.Criteria;
import com.piggame.model.system.SysRoleExample.Criterion;
...
public class SysRoleSqlProvider {
    ...
    public String insertSelective(SysRole record) {
        ...
        if (record.getAvailable() != null) {
            sql.VALUES("available", "#{available,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(SysRole record) {
        ...
        if (record.getAvailable() != null) {
            sql.SET("available = #{available,jdbcType=TINYINT}");
        }
